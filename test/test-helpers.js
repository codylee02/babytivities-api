...
function makeActivitiesArray() {
  return [
    ...
    },
    {
      ...
      type: "Physical",
      instructions:
        "Fill the smaller container with water and place the bath toys inside. Then place the container with water in the larger container. Make sure to model this first for your toddler! Show them how to scoop the bath toys into the empty container before handing them the spoon.",
      age: "13-24m",
      date_created: "2019-11-06 22:26:24.065662"
    },
    {
...
function makeMaterialsArray() {
  return [
    ...
    },
    {
      ...
      item:
        "Small, random items from around the house (Tip: if you want to focus on certain topics, include them in the bag: Letters, different colored paper, different animals, numbers, etc.",
      activity_id: "189100f6-479a-11ea-b77f-2e728ce88125"
    }
  ];
}
